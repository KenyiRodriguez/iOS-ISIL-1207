...
class ModeloDA {
    ...
    class func crear(fabricacion: String, nombre: String, tipoCarroceria: String, urlImagen: String, contexto: NSManagedObjectContext) -> Modelo {
